...
export const sportsConfig: Record<Sport, SportConfig> = {
  ...
  cycling: {
    ...
    workoutTypes: ['endurance', 'sprint', 'hills', 'recovery'],
  },
  swimming: {
    id: 'swimming',
    name: 'Natation',
    emoji: '🏊',
    category: 'endurance',
    description: 'Sport aquatique complet',
    nutrition: {
      calorieModifier: 450,
    ...
    workoutTypes: ['endurance', 'sprint', 'technique', 'recovery'],
  },
  crossfit: {
    id: 'crossfit',
    name: 'CrossFit',
    ...
    workoutTypes: ['wod', 'strength', 'metcon', 'skills'],
  },
  martial_arts: {
    id: 'martial_arts',
    name: 'Arts martiaux',
    emoji: '🥋',
    category: 'combat',
    description: 'Sports de combat et arts martiaux',
    nutrition: {
      calorieModifier: 350,
    ...
    workoutTypes: ['technique', 'sparring', 'conditioning', 'forms'],
  },
  yoga: {
    id: 'yoga',
    name: 'Yoga',
    ...
    description: 'Pratique corps-esprit et flexibilité',
    nutrition: {
      calorieModifier: 150,
